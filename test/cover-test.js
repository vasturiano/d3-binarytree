...
tape("binarytree.cover(x) sets a non-trivial squarified and centered extent if the extent was trivial", function(test) {
  test.deepEqual(d3_binarytree.binarytree().cover(0).cover(2).extent(), [[0], [2]]);
  test.end();
});
...
tape("binarytree.cover(x) repeatedly doubles the existing extent if the extent was non-trivial", function(test) {
  test.deepEqual(d3_binarytree.binarytree().cover(0).cover(2).cover(-1).extent(), [[-2], [2]]);
  test.deepEqual(d3_binarytree.binarytree().cover(0).cover(2).cover(1).extent(), [[0], [2]]);
  test.deepEqual(d3_binarytree.binarytree().cover(0).cover(2).cover(3).extent(), [[0], [4]]);
  test.deepEqual(d3_binarytree.binarytree().cover(0).cover(2).cover(-3).extent(), [[-6], [2]]);
